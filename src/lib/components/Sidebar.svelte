...
<aside
    class="{isExpanded
        ? 'w-64'
        : 'w-24'} bg-bg-secondary border-r border-border-ui flex flex-col py-6 px-4 fixed h-full shadow-lg z-10 transition-all duration-300"
>
    <!-- Botão de Menu Retrátil -->
    <div
        class="flex items-center mb-10 {isExpanded
            ? 'justify-end'
    ...
    <nav class="flex-grow">
        <ul class="space-y-2">
            ...
            <li
                ...
                class="flex items-center rounded-xl {activeTab === 'events'
            ...
            {#if isAdmin}
                ...
                <li
                    ...
                    class="flex items-center rounded-xl {activeTab === 'users'
                        ? 'bg-brand text-white shadow-lg shadow-brand/20'
                        : 'hover:bg-text-primary/5 text-text-secondary hover:text-text-primary'} transition-all cursor-pointer {isExpanded
                        ? 'p-3 gap-3 justify-start'
                        : 'w-12 h-12 justify-center mx-auto'}"
                ...
                >
                    ...
                    {#if isExpanded}
                        <span class="font-medium whitespace-nowrap"
                            >Criar Atividade</span
                        >
                    {/if}
                </li>

                <!-- Link: Gerenciar Atividades -->
                <!-- svelte-ignore a11y_click_events_have_key_events -->
                <!-- svelte-ignore a11y_no_noninteractive_element_interactions -->
                <li
                    onclick={() => (activeTab = "manage_activities")}
                    class="flex items-center rounded-xl {activeTab ===
                    'manage_activities'
                        ? 'bg-brand text-white shadow-lg shadow-brand/20'
                        : 'hover:bg-text-primary/5 text-text-secondary hover:text-text-primary'} transition-all cursor-pointer {isExpanded
                ...
                <!-- svelte-ignore a11y_no_noninteractive_element_interactions -->
                <li
                    onclick={() => (activeTab = "questions_admin")}
                    class="flex items-center rounded-xl {activeTab ===
                    'questions_admin'
                        ? 'bg-brand text-white shadow-lg shadow-brand/20'
                        : 'hover:bg-text-primary/5 text-text-secondary hover:text-text-primary'} transition-all cursor-pointer {isExpanded
                ...
                <li
                    ...
                    class="flex items-center rounded-xl {activeTab === 'sectors'
                        ? 'bg-brand text-white shadow-lg shadow-brand/20'
                        : 'hover:bg-text-primary/5 text-text-secondary hover:text-text-primary'} transition-all cursor-pointer {isExpanded
                        ? 'p-3 gap-3 justify-start'
                        : 'w-12 h-12 justify-center mx-auto'}"
                ...
                <li
                    ...
                    class="flex items-center rounded-xl {activeTab === 'raffle'
                        ? 'bg-brand text-white shadow-lg shadow-brand/20'
                        : 'hover:bg-text-primary/5 text-text-secondary hover:text-text-primary'} transition-all cursor-pointer {isExpanded
                        ? 'p-3 gap-3 justify-start'
                        : 'w-12 h-12 justify-center mx-auto'}"
    ...
    <div
        class="pt-6 border-t border-border-ui space-y-4 overflow-hidden flex flex-col {isExpanded
            ? 'items-stretch'
            : 'items-center'}"
    >
        ...
        <button
            ...
            title="Sair"
            class="flex items-center justify-center rounded-xl border border-text-primary/20 text-text-primary text-xs font-bold hover:bg-red-500 hover:text-white hover:border-red-500 transition-all {isExpanded
                ? 'w-full gap-2 p-2.5'
                : 'w-12 h-12'}"
        >
            <svg
